...
<body style="font-family: 'Cairo', sans-serif">
 ...
 <div id="pre-loader">
      <img src="{{ URL::asset('assets/images/pre-loader/SCHOOL.gif') }}" alt="">
 </div>
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <a class="btn btn-danger" href="{{url('/ar/Students')}}" role="button">Show Students</a>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                Click to list all Students
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <a class="btn btn-warning" href="{{url('/ar/Students/create')}}" role="button">Add Student</a>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <a class="btn btn-success" href="#" role="button">Revenue</a>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <a class="btn btn-primary" href="#" role="button">Followers</a>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
